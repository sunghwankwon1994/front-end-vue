  ...
  <div class="card">
    ...
    <div class="card-body">
      <div>
        ...
        <button class="btn btn-danger btn-sm" @click="handleChildEvent2">
          child-evnet-2 발생
        </button>
      </div>
      <div class="mt-3">
        ...
        <button
          class="btn btn-danger btn-sm me-2"
          @click="handleIncrementEvent"
        >
          증가(increment-event 이벤트 발생)
        </button>
        <button class="btn btn-danger btn-sm" @click="handleDecrementEvent">
          감소(decrement-event 이벤트 발생)
        </button>
