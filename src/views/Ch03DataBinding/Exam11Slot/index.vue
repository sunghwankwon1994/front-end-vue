<template>
  <div class="card">
    ...
    <div class="card-body">
      <button class="btn btn-info btn-sm me-2" @click="showDialogA">
        기본 다이얼로그
      </button>
      <button class="btn btn-info btn-sm me-2" @click="showDialogB">
        알림 다이얼로그
      </button>
      <button class="btn btn-info btn-sm" @click="showDialogC">
        로그인 다이얼로그
      </button>
    </div>
    <DialogA id="dialogA" />
...
//컴포넌트가 생성되고, DOM 부착될때 자동으로 실행되는콜백
onMounted(() => {
